...
# dnf install -y cmake nasm libXv-devel libX11-devel ocl-icd-devel libXext-devel libXtst-devel libGL-devel libGLU-devel libEGL-devel libxcb-devel xcb-util-keysyms-devel
